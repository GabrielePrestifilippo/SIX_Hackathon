...
myApp.controllers = {
	...
	tabbarPage: function (page) {
		...
		Array.prototype.forEach.call(page.querySelectorAll('[component="button/camera"]'), function (element) {
			element.onclick = function () {
				document.querySelector('#myNavigator').pushPage('html/camera.html');
			};
